    ...
    <main className="d-flex align-items-center justify-content-center vh-100">
      <div className="card p-4 shadow border rounded w-100" style={{ maxWidth: '400px' }}>
        ...
        <form onSubmit={onSubmit}>
          ...
          {errorMessage && <span className="text-danger fw-bold">{errorMessage}</span>}
          <button
            type="submit"
        ...
        <p className="text-center mt-3">
          ...
          <Link to="/register" className="fw-bold text-decoration-underline">
            Registrate
          </Link>
        </p>
        ...
        >
          ...
          {isSigningIn ? 'Signing In...' : 'Continuar con Google'}
        </button>
      </div>
    </main>
  );
